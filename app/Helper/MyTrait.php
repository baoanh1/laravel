...
/**
     ...
     * @return string|null
     */
    public  function composeSegments($type, $is_thumb, $file_name)
    {
    ...
    public  function getPathPrefix($type)
    {
        ...
        // dd($this->isProcessingImages());
        if ($this->typefiles == "image") {
     ...
     * @return string
     */
    public  function getFormatedWorkingDir()
    {
     ...
     * @return string|null
     */
    public  function appendThumbFolderPath($is_thumb)
    {
        if (! $is_thumb) {
            return;
        }
     ...
     * @return string
     */
    public  function removeDuplicateSlash($path)
    {
     ...
     * @return string
     */
    public  function removeLastSlash($path)
    {
        // remove last slash
     ...
     * @return bool
     */
    public  function isProcessingImages($typefile=null)
    {
        // dd(1);
    ...
    /**
     * Check if users are allowed to use their public  folders.
     *
     * @return bool
     */
    ...
    /**
     * Get the name of public  folder of current user.
     *
     * @return string
     */
