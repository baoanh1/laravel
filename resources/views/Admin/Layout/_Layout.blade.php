...
<input type="hidden" id="baseurl" name="baseurl" value="{{url('/')}}" />
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i>{{auth::user()->name}} - ({{auth::user()->roles->first()->name}})</a>
                        </li>
                        <li><a href="#"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="{{url('index')}}" target="_blank"><i class="fa fa-sign-out fa-fw"></i> view site</a>
                        </li>
                        <li class="divider"></li>
    ...
    <script src="{{url('Admin_Asset/js/myjs.js')}}"></script>
    <!-- Custom Theme JavaScript -->
    <script src="Admin_Asset/dist/js/sb-admin-2.js"></script>
    {{--<script src="ckeditor/ckeditor.js"></script>--}}
    {{--<script src="ckfinder/ckfinder.js"></script>--}}
    {{--<script src="kcfinder/ckfinder.js"></script>--}}
    @yield('jsFooter')
</body>
